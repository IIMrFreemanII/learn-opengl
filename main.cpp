...
//    glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
    ...
    // ------------------------------------
    Shader lightingShader("assets/shaders/2.2.basic_lighting.vert", "assets/shaders/2.2.basic_lighting.frag");
    Shader lightCubeShader("assets/shaders/1.light_cube.vert", "assets/shaders/1.light_cube.frag");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        */
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            lightingShader.setFloat("pointLights[" + number + "].linear", 0.09);
            lightingShader.setFloat("pointLights[" + number + "].quadratic", 0.032);
        }
